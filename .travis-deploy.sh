# Source: https://blog.ngconsultant.io/continuous-deployment-of-client-side-apps-with-github-pages-travis-ci-10e9d641a889
...
git config user.email "jacib.t.fischer@gmail.com"
