...
export const CardOptionsList: CardOption[] = [
    ...
    },
    {
        name: 'Variant',
        type: 'checkbox',
        description: `If enabled, the card's textbox will be black instead of white, such as for the Villain Stack. If the type is "Hero" or "Villain", then they also gain the special "Super Hero/Villain" subtype. This option has no effect on Oversized cartd`,
    },
    {
        name: 'Oversized',
        type: 'checkbox',
    ...
    },
    {
        name: 'Image URL',
        type: 'url',
        description: `URL to the image for this card. We recommend using a site like <a href="https://imgur.com/">imgur</a> to manage your images. The image will be automatically centered on the card. Normal cards will be 750px × 523px in size, and Oversized ones will be 900px × 741px.`,
    },
    {
        name: 'Logo URL',
        type: 'url',
        description: `URL to the image for the logo in the top right of this card. For both sizes of cards the image will be rendered at 175px × 175px.`,
    },
    {
        name: 'Logo Scale',
        type: 'number',
    ...
    },
    {
        name: 'Copyright',
        type: 'text',
        description: `The year and company the card is Copyright from. The © symbol is added automatically, and if this is omitted just the year will be displayed, e.g. "©${new Date().getFullYear()}".`,
    },
    {
        name: 'Legal',
        type: 'text',
