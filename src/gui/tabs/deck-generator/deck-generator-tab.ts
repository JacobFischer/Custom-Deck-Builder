...
import { DeckBuilder, DeckBuilderSymbols } from 'src/cards/deck-builder';
    ...
    private generate(): void {
        ...
        if (file) {
            ...
            reader.addEventListener('load', () => {
                ...
                let batches = 1;
                let currentBatch = 1;
                deckBuilder.on(DeckBuilderSymbols.parsed, (numNormalCards: number, numOversizedCards: number) => {
